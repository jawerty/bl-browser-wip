    ...
    <div className="container">
      ...
      <div className="bars">
        <div className="bar address-bar">
          ...
          />
          <div className={cx('action', 'query-ui-toggle')} onClick={isLoading ? null : action.toggleQueryUI.bind(this, activeID)}>
            <IconQueryUI />
          </div>
        </div>
      </div>
